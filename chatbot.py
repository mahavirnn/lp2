...
greetings = ['Hello!', 'Hi!', 'Hey there!', 'Greetings!', 'Hi, Nice to see you!']
goodbyes = ['Goodbye!', 'See you later!', 'Farewell!', 'Bye!', 'Take care!']
help_responses = ['How may I assist you?',
                  'What can I do for you?', 'How can I help?']
problem_responses = ['I am sorry to hear that. Can you please tell me more about the problem?',
                     'Let me see if I can help. What seems to be the issue?', 'I will do my best to help you. What\'s the problem?']
thankyou_responses = ['You are welcome!', 'No problem!',
...
def chatbot():
    ...
    while True:
        ...
        if 'hello' in user_input.lower() or 'hi' in user_input.lower() or 'hey' in user_input.lower():
            ...
            print(
                'Chatbot: I\'m sorry, I don\'t understand. Can you please rephrase your request?')
